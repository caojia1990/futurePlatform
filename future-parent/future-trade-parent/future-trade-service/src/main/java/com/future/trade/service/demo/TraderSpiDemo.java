 ...
 */
public class TraderSpiDemo extends CThostFtdcTraderSpi {

    static Logger logger = Logger.getLogger(TraderSpiDemo.class);
	...
	public TraderSpiDemo(CThostFtdcTraderApi traderApi) {
    ...
    public void OnFrontConnected(){
        ...
        field.setBrokerID(TradeDemo.BROKER_ID);
        field.setUserID(TradeDemo.USER_ID);
        field.setPassword(TradeDemo.PASSWORD);
	...
	public void OnRspUserLogin(CThostFtdcRspUserLoginField pRspUserLogin,
		...
		positionField.setBrokerID(TradeDemo.BROKER_ID);
		positionField.setInstrumentID("cu1703");
		positionField.setInvestorID(TradeDemo.USER_ID);
		...
		confirmField.setBrokerID(TradeDemo.BROKER_ID);
		confirmField.setInvestorID(TradeDemo.USER_ID);
   ...
   /**
    ...
    public void OnRspQryInstrument(CThostFtdcInstrumentField pInstrument, CThostFtdcRspInfoField pRspInfo, int nRequestID, boolean bIsLast) {
	    ...
	    if(bIsLast){
	        ...
	        pQryOrder.setInvestorID(TradeDemo.USER_ID);
